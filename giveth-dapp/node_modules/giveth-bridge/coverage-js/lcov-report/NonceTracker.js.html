...
<html lang="en">
<head>
    <title>Code coverage report for NonceTracker.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> NonceTracker.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import semaphore from 'semaphore';
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (nonce + 1 !== n) {
...
&nbsp;
        if (isHomeTx) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!broadcasted) <span class="cstat-no" title="statement not covered" >this.homeNonce--;</span>
            this.homeSem.leave();
        } else {
