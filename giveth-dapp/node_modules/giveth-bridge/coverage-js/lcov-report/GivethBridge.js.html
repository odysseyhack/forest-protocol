...
<html lang="en">
<head>
    <title>Code coverage report for GivethBridge.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> GivethBridge.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import logger from 'winston';
        ...
        switch (event.event) {
            case 'Donate': {
                ...
                return Promise.all([
                    ...
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (!tx)
<span class="cstat-no" title="statement not covered" >                        throw new Error(`Failed to fetch transaction ${event.transactionHash}`);</span>
                    return {
