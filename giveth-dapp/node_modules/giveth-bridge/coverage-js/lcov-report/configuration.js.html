...
<html lang="en">
<head>
    <title>Code coverage report for configuration.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> configuration.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
<span class="missing-if-branch" title="else path not taken" >E</span>if (!ENVIRONMENT &amp;&amp; NODE_ENV) ENVIRONMENT = NODE_ENV;
/* istanbul ignore next */
if (!ENVIRONMENT) ENVIRONMENT = 'local';
&nbsp;
const config = JSON.parse(fs.readFileSync(path.join(__dirname, '../config/default.json')));
&nbsp;
<span class="missing-if-branch" title="else path not taken" >E</span>if (ENVIRONMENT &amp;&amp; fs.existsSync(path.join(__dirname, `../config/${ENVIRONMENT}.json`))) {
