...
var LPPCampaignState = function () {
  ...
  _createClass(LPPCampaignState, [{
    ...
    value: function getState() {
      return Promise.all([this.campaign.liquidPledging(), this.campaign.idProject(), this.campaign.reviewer(), this.campaign.newReviewer(), this.campaign.isCanceled()]).then(function (results) {
        return {
